 ...
 */
class ShippingCostOverride implements EbayModelInterface
{
    use FillsModel;
     ...
     *
     * @var ShippingServiceTypeEnum|null
     */
    #[Assert\Type(ShippingServiceTypeEnum::class)]
    public ?ShippingServiceTypeEnum $shippingServiceType = null;
