# EBay\Inventory\InventoryItemApi
...
> \EBay\Inventory\Model\BulkInventoryItemResponse bulkCreateOrReplaceInventoryItem($body)
...
------------- | ------------- | ------------- | -------------
 **body** | [**\EBay\Inventory\Model\BulkInventoryItem**](../Model/BulkInventoryItem.md)| Details of the inventories with sku and locale |

### Return type

[**\EBay\Inventory\Model\BulkInventoryItemResponse**](../Model/BulkInventoryItemResponse.md)
...
> \EBay\Inventory\Model\BulkGetInventoryItemResponse bulkGetInventoryItem($body)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\EBay\Inventory\Model\BulkGetInventoryItem**](../Model/BulkGetInventoryItem.md)| Details of the inventories with sku and locale |

### Return type

[**\EBay\Inventory\Model\BulkGetInventoryItemResponse**](../Model/BulkGetInventoryItemResponse.md)
...
> \EBay\Inventory\Model\BulkPriceQuantityResponse bulkUpdatePriceQuantity($body)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\EBay\Inventory\Model\BulkPriceQuantity**](../Model/BulkPriceQuantity.md)| Price and allocation details for the given SKU and Marketplace |

### Return type

[**\EBay\Inventory\Model\BulkPriceQuantityResponse**](../Model/BulkPriceQuantityResponse.md)
...
> \EBay\Inventory\Model\BaseResponse createOrReplaceInventoryItem($body, $contentLanguage, $sku)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\EBay\Inventory\Model\InventoryItem**](../Model/InventoryItem.md)| Details of the inventory item record. |
...
# **getInventoryItem**
> \EBay\Inventory\Model\InventoryItemWithSkuLocaleGroupid getInventoryItem($sku)
...
[**\EBay\Inventory\Model\InventoryItemWithSkuLocaleGroupid**](../Model/InventoryItemWithSkuLocaleGroupid.md)
...
# **getInventoryItems**
> \EBay\Inventory\Model\InventoryItems getInventoryItems($limit, $offset)
...
[**\EBay\Inventory\Model\InventoryItems**](../Model/InventoryItems.md)
