# SapientPro\EbayInventorySDK\ListingApi
...
|----------|---------------------------------------------------------------------------------------------|------------------------------------------------------------------|-------|
| **body** | [**SapientPro\EbayInventorySDK\Models\BulkMigrateListing**](../Model/BulkMigrateListing.md) | Details of the listings that needs to be migrated into Inventory |       |

### Return type

[**SapientPro\EbayInventorySDK\Models\BulkMigrateListingResponse**](../Model/BulkMigrateListingResponse.md)
