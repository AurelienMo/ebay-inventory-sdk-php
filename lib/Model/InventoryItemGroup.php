...
class InventoryItemGroup implements ModelInterface, ArrayAccess
{
     ...
     * Sets variesBy
     *
     * @param  VariesBy  $variesBy  variesBy
     *
     * @return $this
     */
