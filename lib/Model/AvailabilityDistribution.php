...
class AvailabilityDistribution implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param  string  $merchantLocationKey  The unique identifier of an inventory location where quantity is available for the inventory item. This field is conditionally required to identify the inventory location that has quantity of the inventory item.
     *
     * @return $this
     */
