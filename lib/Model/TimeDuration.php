...
class TimeDuration implements ModelInterface, ArrayAccess
{
     ...
     * Sets unit
     *
     * @param  string  $unit  This enumeration value indicates the time unit used to specify the fulfillment time, such as <code>HOUR</code> or <code>BUSINESS_DAY</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/inventory/types/slr:TimeDurationUnitEnum'>eBay API documentation</a>
     *
     * @return $this
     */
