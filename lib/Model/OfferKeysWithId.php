...
class OfferKeysWithId implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes
        = [
            'offers' => '\EBay\Inventory\Model\OfferKeyWithId[]',
        ];
